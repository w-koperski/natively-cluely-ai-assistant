...
exports.checkAnswerForCodeBugs = checkAnswerForCodeBugs;
const MAX_EXCERPT_LENGTH = 200;
function truncate(line) {
    if (line.length <= MAX_EXCERPT_LENGTH)
        return line;
 ...
 */
function checkAnswerForCodeBugs(answer) {
    ...
    for (const line of proseLines) {
        if (!/calculat|comput|find|gives|see\s/i.test(line))
            continue;
...
//# sourceMappingURL=CodeSanityCheck.js.map