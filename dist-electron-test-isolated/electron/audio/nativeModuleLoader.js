 ...
 */
function validateNativeModule(mod) {
    ...
    if (!Array.isArray(result)) {
        throw new Error(`NativeModule: getInputDevices() returned ${typeof result} instead of Array` +
...
function loadNativeModule() {
    ...
    const packagedPath = process.resourcesPath
        ? path_1.default.join(process.resourcesPath, 'app.asar.unpacked', 'native-module', binary)
        : null;
    const devPath = path_1.default.join(appPath, 'native-module', binary);
    const devFallbackPath = path_1.default.join(appPath, '..', 'native-module', binary);
...
//# sourceMappingURL=nativeModuleLoader.js.map