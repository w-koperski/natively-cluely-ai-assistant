...
exports.CropperWindowHelper = void 0;
...
class CropperWindowHelper {
    ...
    constructor() {
        ...
        this.confirmedListener = (event, bounds) => {
        ...
        electron_1.ipcMain.on('cropper-confirmed', this.confirmedListener);
        electron_1.ipcMain.on('cropper-cancelled', this.cancelledListener);
        ...
        this.beforeQuitHandler = () => {
            if (!this.isDisposed) {
                ...
                electron_1.ipcMain.removeListener('cropper-confirmed', this.confirmedListener);
                electron_1.ipcMain.removeListener('cropper-cancelled', this.cancelledListener);
            }
        };
        electron_1.app.on('before-quit', this.beforeQuitHandler);
    }
    /**
     ...
     */
    resolveCurrentSelection(bounds) {
     ...
     */
    async showCropper(timeout = 30000) {
        if (this.isDisposed) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (this.cropperWindow && !this.cropperWindow.isDestroyed()) {
                ...
                const cursorPosition = electron_1.screen.getCursorScreenPoint();
                const displays = electron_1.screen.getAllDisplays();
     ...
     */
    applyOpacityShield() {
        if (!this.cropperWindow || this.isDisposed)
            return;
    ...
    createWindow(showImmediately) {
        ...
        this.cropperWindow = new electron_1.BrowserWindow(windowSettings);
    ...
    dispose() {
        ...
        if (this.beforeQuitHandler) {
            electron_1.app.removeListener('before-quit', this.beforeQuitHandler);
...
exports.CropperWindowHelper = CropperWindowHelper;
//# sourceMappingURL=CropperWindowHelper.js.map