...
function containsPromptInjection(text) {
    return exports.DANGEROUS_PATTERNS.some(pattern => pattern.test(text));
}
//# sourceMappingURL=TrustLevels.js.map