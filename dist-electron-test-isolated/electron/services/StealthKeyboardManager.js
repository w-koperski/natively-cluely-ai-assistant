...
exports.StealthKeyboardManager = void 0;
 ...
 */
class StealthKeyboardManager {
    static instance = null;
    tap = null; // StealthKeyboardTap instance from native module
    active = false;
    ...
    openSettings() {
        ...
        const tryOpen = (url) => Promise.resolve(electron_1.shell.openExternal(url));
    ...
    createTapInstance() {
        ...
        try {
            ...
            if (typeof Ctor !== 'function') {
                if ((0, verboseLog_1.isVerboseLogging)()) {
                    console.warn('[StealthKeyboardManager] StealthKeyboardTap constructor missing from native binary — rebuild with `npm run build:native` for stealth typing');
                }
                return null;
            }
            return new Ctor();
...
exports.StealthKeyboardManager = StealthKeyboardManager;
//# sourceMappingURL=StealthKeyboardManager.js.map