...
exports.DynamicActionDetector = exports.MODE_TRIGGERS = void 0;
const GENERAL_TRIGGERS = [
    {
        ...
        promptInstruction: 'You are in General mode. The user needs help responding. Provide a concise, context-aware answer they can say out loud.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in General mode. Summarize the relevant discussion into the fewest useful bullets.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in General mode. Explain the current topic plainly and avoid inventing details not present in context.',
...
const NEGOTIATION_TRIGGERS = [
    {
        ...
        promptInstruction: 'You are in Negotiation mode. Respond to a budget probe without anchoring too low. Ask a calibrated question and protect leverage.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Negotiation mode. The other side is pushing on price. Defend value, trade concessions for commitments, and avoid unilateral discounting.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Negotiation mode. Respond to a final-offer frame by testing constraints, preserving optionality, and proposing a concrete next move.',
...
const SALES_TRIGGERS = [
    {
        ...
        promptInstruction: "You are in Sales mode. The prospect has raised a pricing concern. Provide a concise, confident response that addresses value over cost. Include a bridge to next steps.",
    ...
    },
    {
        ...
        promptInstruction: "You are in Sales mode. The prospect mentioned a competitor. Position Natively's advantages confidently without disparaging the competitor.",
    ...
    },
    {
        ...
        promptInstruction: "You are in Sales mode. The prospect is showing strong buying intent. Help finalize the next steps and create urgency.",
    ...
    },
    {
        ...
        promptInstruction: 'You are in Sales mode. The prospect is asking for ROI. Tie benefits to measurable business outcomes and ask for their success metric.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Sales mode. The prospect asked for pricing. Qualify scope before giving numbers and propose a concrete follow-up.',
        answerStyle: { maxWords: 90, format: 'short_script', tone: 'consultative' },
    },
];
// Recruiting triggers
const RECRUITING_TRIGGERS = [
    {
        ...
        promptInstruction: 'You are in Recruiting mode. The candidate has raised a concern. Address it factually and empathetically.',
    ...
    },
    {
        ...
        promptInstruction: "You are in Recruiting mode. The candidate is showing strong interest. Reinforce why this role is a great match.",
    ...
    },
    {
        ...
        promptInstruction: 'You are in Recruiting mode. Help assess and guide the candidate response around experience, motivation, and fit.',
...
const TEAM_TRIGGERS = [
    {
        ...
        promptInstruction: 'You are in Team Meeting mode. Extract the action item: who will do what by when.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Team Meeting mode. Identify the blocker, owner, impact, and next unblock step.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Team Meeting mode. Turn the discussion into an explicit owner, deliverable, and deadline.',
        answerStyle: { maxWords: 60, format: 'checklist', tone: 'direct' },
    },
];
// Interview triggers
const INTERVIEW_TRIGGERS = [
    {
        ...
        promptInstruction: 'You are in Interview mode. The interviewer asked a behavioral question. Structure your answer using the STAR method (Situation, Task, Action, Result) with specific metrics.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Interview mode. Create a crisp candidate intro that connects background, strengths, and why this role fits.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Interview mode. Answer why this company using concrete signals from the conversation and avoid generic flattery.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Interview mode. Answer the weakness question honestly with a real mitigation and evidence of progress.',
...
const LECTURE_TRIGGERS = [
    {
        ...
        promptInstruction: 'You are in Lecture mode. Explain the concept clearly with a practical example.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Lecture mode. Turn the concept into a worked example with steps and the intuition behind each step.',
...
const TECHNICAL_TRIGGERS = [
    {
        ...
        promptInstruction: 'You are in Technical Interview mode. Provide a clear, efficient solution with time/space complexity analysis.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Technical Interview mode. A coding problem is visible on the screen. Read the visible problem carefully and provide a solution.',
    },
    {
        ...
        promptInstruction: 'You are in Technical Interview mode. Explain the complexity tradeoff clearly and suggest the next optimization path.',
    ...
    },
    {
        ...
        promptInstruction: 'You are in Technical Interview mode. Structure the system design answer around requirements, APIs, data model, scaling, and tradeoffs.',
        answerStyle: { maxWords: 260, format: 'bullets', tone: 'analytical' },
    },
];
exports.MODE_TRIGGERS = {
...
class DynamicActionDetector {
    triggers;
    constructor(triggers = exports.MODE_TRIGGERS) {
...
exports.DynamicActionDetector = DynamicActionDetector;
//# sourceMappingURL=DynamicActionDetector.js.map